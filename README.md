# Awesome Tornado | [![Awesome](https://awesome.re/badge-flat.svg)]

> A curated list of awesome things related to Tornado

[Tornado](https://www.tornadoweb.org/en/stable/index.html) is a Python web framework and asynchronous networking library, originally developed at FriendFeed
...
### HTTP / Networking
- [firenado](https://github.com/candango/firenado) - Web Framework that extends Tornado Web organizing the application, and adding extra features.
